...
export default function PembayaranSambungan(props) {
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        post(route("pelanggan.bayar-tagihan-pemasangan-baru"));
    };
    return (
        <div className="py-6">
            <p className="text-sm py-1 px-2 rounded-md bg-gray-200 text-slate-900">
                Setelah melakukan pembayaran, petugas akan melakukan pengecekan
                data terlebih dahulu. ketika pembayaran tela diterima maka
                petugas akan menghubungi anda. untuk tindak lanjut pemasangan
                meteran
            </p>
