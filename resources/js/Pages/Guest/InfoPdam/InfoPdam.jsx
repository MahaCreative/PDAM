...
export default function InfoPdam(props) {
    ...
    const reload = useCallback(
        debounce((query) => {
            router.get(route("info-pdam"), query, {
                preserveScroll: true,
                preserveState: true,
            });
        }, 150),
            ...
            <Layout>
                <div className="px-2 md:px-4 lg:px-8 w-[100%] md:w-[70%]">
                    ...
                    <h3 className="font-bold capitalize font-fira text-4xl text-blue-800 Misi py-8">
                        Info Pdam terbaru {settingApps.nama_perusaaan}
                    </h3>
...
InfoPdam.layout = (page) => <GuestLayout children={page} title={"Info PDAM"} />;
