...
export default function Galery(props) {
    ...
    const onDeleteHandler = () => {
        router.delete(route("admin.delete-galery", model.id), {
            onSuccess: () => {
    ...
    const reload = useCallback(
        debounce((query) => {
            router.get(route("admin.galery"), query, {
                preserveScroll: true,
                preserveState: true,
            });
        }, 150),
    ...
    return (
        <div className="py-6 px-8">
            <Modal
                ...
                title={model ? "Update Galery" : "Tambah Galery"}
            >
                <Form
                    model={model}
                    setModel={setModel}
...
Galery.layout = (page) => (
    <AdminLayout children={page} title={"Kelola Galery"} />
);
