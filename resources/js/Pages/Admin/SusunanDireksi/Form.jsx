...
export default function Form({ model, setModel, setOpen }) {
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        if (model) {
            post(route("admin.update-direksi"));
        } else {
            post(route("admin.create-direksi"));
        }
    };
    return (
        <form className="w-full" onSubmit={submitHandler}>
            ...
            <div className="div flex flex-col md:flex-row gap-3">
